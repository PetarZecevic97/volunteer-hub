...
namespace Ads.Persistence
{
	public class AdContextSeed
	{
        ...
        {
            var ad1 = new AdEntity(System.Guid.NewGuid().ToString(), "Budite kul s nama", "Netflix&Chill", "kulj, hladan, krastavac", true, "Bg", "asd1234");
            var ad2 = new AdEntity(System.Guid.NewGuid().ToString(), "DogPetCenter", "Mazimo kerove zajedno", "kuckari, furryBabies", true, "Novi sad", "ghjk8890");
            ...
            var ad4 = new AdEntity(System.Guid.NewGuid().ToString(), "Napravite nam kulji opis", "Sranje nam je opis, molim vas pomagajte kako znate i mozete", "umjetnik u opisu", true, "Nis", "www333");
