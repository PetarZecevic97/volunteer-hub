...
export const inputFieldsforSignup = [
  ...
  { type: "text", name: "pass", labelName: "Password", errorName: "pass" },
  {
    type: "radio",
    name: "role",
    choices: ["Volunteer", "Organization"],
    labelName: "Role",
    errorName: "role",
  },
  {
...
export const inputFieldsforSignin = [
  ...
  { type: "checkbox", name: "remember", labelName: "Remember me" },
  {
    type: "href",
    name: "sign-up",
    labelName: "Don't have an account? Sign Up",
  },
...
export const inputFieldsforCreateAdForm = [
  ...
  },
  {
    type: "text",
    name: "skills",
    labelName: "Skills necessary",
    errorName: "skills",
  },
  {
    type: "checkbox",
    name: "isEmergency",
    labelName: "Is this an emergency?",
    errorName: "isEmergency",
  },
];
...
export const inputFieldsforUpdateAdForm = [
  ...
  },
  {
    type: "checkbox",
    name: "isOpen",
    labelName: "Is the Application Open? ",
    errorName: "isOpen",
  },
];
