...
import { CREATE_VOLUNTEER, GET_VOLUNTEER, GET_VOLUNTEER_LIST, UPDATE_VOLUNTEER, DELETE_VOLUNTEER } from "../types/volunteerTypes";
...
export const updateVolunteer = (volunteerId: any, dataForCreate: any) => async (dispatch: any) =>  {
  const volunteer = await userService.updateVolunteer(dataForCreate, volunteerId);
  return dispatch({
