...
namespace Organization.Persistence
{
    public class OrganizationContextSeed
    {
        ...
        {
            var organization1 = new OrganizationEntity(1, "nikola", DateTime.MinValue, null, null, "organization_1", "asd1234", "This is a very cool organization!");
            var organization2 = new OrganizationEntity(2, "nikola", DateTime.MinValue, null, null, "organization_2", "ghjk8890", "We love dogs, come help us pet them!");
            var organization3 = new OrganizationEntity(3, "nikola", DateTime.MinValue, null, null, "organization_3", "xyz987", "The government is lying to you, help us spread the word!");
